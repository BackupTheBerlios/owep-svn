...
<template:template nom="/JSP/Template/FTemplate.jsp">
  <template:section region="RegionTitre"      contenu="<%=messages.getString("avancementGlobalProjetTitre")%>"   typePage="false"/> 
  <template:section region="RegionPrincipal"  contenu="/JSP/Avancement/FAvancementGlobalProjet.jsp" typePage="true"/>
