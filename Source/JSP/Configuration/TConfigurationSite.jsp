...
<template:template nom="/JSP/Template/FTemplate.jsp">
  <template:section region="RegionTitre"      contenu="<%=messages.getString("configurationSiteTitre")%>" typePage="false"/>
  <template:section region="RegionPrincipal"  contenu="/JSP/Configuration/FConfigurationSite.jsp"         typePage="true"/>
