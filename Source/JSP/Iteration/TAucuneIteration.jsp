...
<template:template nom="/JSP/Template/FTemplate.jsp">
  <template:section region="RegionTitre"      contenu="<%=messages.getString("aucuneIterationTitre")%>"  typePage="false"/>
  <template:section region="RegionPrincipal"  contenu="/JSP/Iteration/FAucuneIteration.jsp" typePage="true"/>
