...
<template:template nom="/JSP/Template/FTemplate.jsp">
  <template:section region="RegionTitre"      contenu="<%= messages.getString(\"tachesImprevues\")%>" typePage="false"/>
  <template:section region="RegionPrincipal"  contenu="/JSP/Processus/FTacheImprevue.jsp"             typePage="true"/>
