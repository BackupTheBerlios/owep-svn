...
<template:template nom="/JSP/Template/FTemplate.jsp">
  <template:section region="RegionTitre"      contenu="Rapport d'activité"              typePage="false"/>
  <template:section region="RegionPrincipal"  contenu="/JSP/Tache/FRapportActivite.jsp" typePage="true"/>
